...
public class WavFileHelper {    
    ...
    public static void main(String[] args) {
        ...
        String inputFile = "D:/test.wav"; // Place the wav file in the top level directory, ie S:/input.wav
        String outputFile = "D:/output.wav";
        String recordedFile = "D:/capture.wav";
